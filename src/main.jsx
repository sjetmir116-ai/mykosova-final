      ...
      return (
        <div style={{ padding: '40px', fontFamily: 'system-ui, sans-serif', maxWidth: '600px', margin: '0 auto' }}>
          ...
          <p style={{ fontSize: '12px', fontWeight: '800', color: '#6b7280', marginTop: '8px' }}>
            Vershioni i kodit që po ekzekutohet: <span style={{ color: VERSIONI === '1.0.8' ? '#16a34a' : '#ef4444' }}>{VERSIONI}</span>
            {VERSIONI !== '1.0.8' && ' — ⚠️ KËTË KËSHILLËN TË VJETËR! Bëj hard refresh (Ctrl+Shift+R) ose hap në tab të ri.'}
          </p>
          <button
