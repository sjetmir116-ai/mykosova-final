...
const ATRAKSIONET_LOKALE = [
  ...
  {
    emri: 'Thethi', qyteti: 'Kukës (Shqipëri)', kategoria: 'Fshatra', ikona: '🏘️',
    lat: 42.5500, lng: 20.1500,
    pershkrimi: 'Fshati legjendar alban — shtëpi tradicionale me gur, ujëvara, shtegjet e thëna me gur dhe mikpritje unike. Pikë e preferuar për dita nga Peja dhe Prizreni.',
  ...
  {
    emri: 'Liqeni i Preshevës (Kozjak)', qyteti: 'Preshevë', kategoria: 'Liqene', ikona: '🦆',
